...
import { type IFetch } from '../types'
// import type { IFetchServer } from '../../server/type'
import { type ClientOptions } from './types'

// const defaultClientAPI = getDefaultClientAPI<IFetchServer>()
export function constructAPI(api: Remote<IFetch>): IFetch {
  return {
    rawFetch: api.rawFetch,
    fetchCancel: api.fetchCancel,
    fetchSend: api.fetchSend,
    fetchReadBody: api.fetchReadBody
  }
}
